...
$lines   = [];
$lines[] = sprintf(esc_html__('Order #%1$s from %2$s is waiting for your approval.', 'tapin'), $order_number, $site_name);
if ($customer_name !== '') {
...
$lines[] = sprintf(esc_html__('Review this order: %s', 'tapin'), $dashboard_url);
