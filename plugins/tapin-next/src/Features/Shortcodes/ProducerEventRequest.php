    ...
    public function render($atts): string {
        ...
        <div class="tapin-center-container" style="max-width:780px">
          ...
          <form id="tapinForm" method="post" enctype="multipart/form-data" class="tapin-card" novalidate>
            ...
            <div class="tapin-form-row"><label>תמונת רקע לדף המכירה (לא חובה)</label><input type="file" name="tapin_bg_image" accept="image/*"><small style="display:block;margin-top:6px;color:#475569;font-size:.85rem;">מומלץ להעלות תמונה לרוחב של 1920 פיקסלים לפחות כדי לשמור על חדות בכל מסך.</small></div>
