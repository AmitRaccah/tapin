...
final class Compat implements Service {
    public function register(): void {
        ...
        add_action('admin_notices', function () {
            ...
            $tags = [
                'events_admin_center',
                'producer_event_request',
                'producer_events_center',
                'producer_events_grid',
                'producer_requests_manager',
                'producer_order_approvals',
                'producer_event_sales',
                'producer_signup',
            ];
    ...
    public function normalizeShortcodes(string $content): string {
        ...
        $pattern = '/\[\[(\s*(?:events_admin_center|producer_event_request|producer_events_center|producer_events_grid|producer_requests_manager|producer_order_approvals|producer_event_sales|producer_signup)\b[^\]]*)\]\]/i';
